#include "createpsactivityscreen.h"
#include "ui_createpsactivityscreen.h"
...
createpsactivityscreen::createpsactivityscreen(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::createpsactivityscreen)
{
    ui->setupUi(this);
...
createpsactivityscreen::~createpsactivityscreen()
{
    delete ui;
}

void createpsactivityscreen::on_backButton_clicked()
{
    w->setCentralWidget(new activitytypeselectionscreen);
}

void createpsactivityscreen::on_createActivityButton_clicked()
{
    QMessageBox box;
            ...
            ui->selectLanguageBox->currentText() != "Select Language...")
    {
        ...
        new_activity.SetParameter("isProblemSetActivity", "1");
        ...
        if (success) {//activity created
            if (itemModel->rowCount() > 0){//have rubric
                ...
                box.setText("Problem Set and Section(s) were created successfully!");
                box.exec();
            } else { //no rubric
                box.setText("Problem Set was created successfully!");
                box.exec();
            }
...
void createpsactivityscreen::on_toolButton_clicked()
{
...
void createpsactivityscreen::on_toolButton_2_clicked()
{
...
void createpsactivityscreen::on_toolButton_3_clicked()
{
    QString dirName = QFileDialog::getExistingDirectory(this, tr("Choose Directory"), "", QFileDialog::ShowDirsOnly);
    ui->gradeDirEdit->setText(dirName);
}

void createpsactivityscreen::on_AddBtn_clicked()
{
    QString text;
...
void createpsactivityscreen::on_RemoveBtn_clicked()
{
...
void createpsactivityscreen::on_pushButton_clicked()
{
    //reset screen
